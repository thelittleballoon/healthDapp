contract('Register', function(accounts) {
  ...
  it('should get the numbers of members as an integer',function(){
    var c_Register = Register.deployed()
    return c_Register.getNumMembers.call().then(function(numMem){
      assert.typeOf(parseFloat(numMem.valueOf()),'number')
    })
  })
})
